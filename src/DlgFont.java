...
class DlgFont extends JDialog{
	...
	DlgFont(Notepad frmNotepad){
		...
		lstFontName.setSelectionMode(ListSelectionModel.SINGLE_INTERVAL_SELECTION);
		lstFontStyle=new JList();
		lstFontStyle.setSelectionMode(ListSelectionModel.MULTIPLE_INTERVAL_SELECTION);
		lstFontSize=new JList();
		lstFontSize.setSelectionMode(ListSelectionModel.MULTIPLE_INTERVAL_SELECTION);
		...
		btnOk.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent ae){
				...
				frmNotepad.jta.setFont(frmNotepad.defaultFnt);
				try{
